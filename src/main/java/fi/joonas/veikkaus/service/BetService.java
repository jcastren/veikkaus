...
public class BetService {
	...
	public Long insert(String userId, String statusId) throws VeikkausDaoException {
	...
	public Long modify(String id, String statusId, String userId) throws VeikkausDaoException {
		Bet bet = betDao.findOne(Long.valueOf(id));
		if (bet == null) {
			throw new VeikkausDaoException("bet with id: " + id + " wasn't found, modify failed");
		}
		...
		if (status == null) {
			throw new VeikkausDaoException("status with id: " + id + " wasn't found, modify failed");
		}
