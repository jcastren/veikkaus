...
public class TournamentTeamService {
	...
	public Long insert(String tournamentId, String teamId) throws VeikkausServiceException {
	...
	public Long modify(String id, String tournamentId, String teamId) throws VeikkausServiceException {
